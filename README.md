...
3. Deploy 4 OpenTelemetry Collectors
4. Configure OpenTelemetry Collector service pipeline for data enrichment
5. Analyze metrics, traces, and logs in Dynatrace
6. Observe OpenTelemetry Collector health in Dynatrace
